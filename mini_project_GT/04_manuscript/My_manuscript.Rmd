...
# Load the CSV file
table <- read.csv("../03_figures/table_peak_fl_sen.csv", sep = ",")

# Display the table with a caption
knitr::kable(table, caption = "Peak flowering and senescing events of Achillea Millefolium for  every botanical garden")
```
